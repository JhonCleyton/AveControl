...
from routes.gerenciamento_produto import bp_gerenciamento_produto
from custo_aves import bp as custo_aves_bp
from analise_custos import bp as analise_custos_bp
from utils import filters, email_sender
...
def create_app():
    ...
    app.register_blueprint(fluxograma_bp, url_prefix='/fluxograma')
    app.register_blueprint(custo_aves_bp, url_prefix='/custo-aves')
    app.register_blueprint(analise_custos_bp, url_prefix='/analise-custos')
    app.register_blueprint(bp_gerenciamento_produto)
